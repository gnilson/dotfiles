...
(defvar butter1 "#fce94f") (defvar butter2  "#f2f455") (defvar butter3 "#c4a000")
...
;;     (font-lock-comment-face ((t (:foreground ,alum4))))
  ;;   (font-lock-comment-face ((t (:foreground ,"#d95548"))))
     ...
     (font-lock-string-face ((t (:foreground ,"#9aef90"))))

     ;;;; gnilson additions ;;;;
     ;;(py-pseudo-keyword-face ((t (:foreground ,orange2))))
     ;;;;;;;;;;;;
